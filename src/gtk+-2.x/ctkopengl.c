                          ...
                          CtkEvent *ctk_event)
{
    ...
    if (ret_show_graphics_visual_indicator == NvCtrlSuccess) {
        ...
        label = gtk_label_new("使用图形API视觉指示器");
