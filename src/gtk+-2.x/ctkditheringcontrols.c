                                      ...
                                      char *name)
{
    ...
    ctk_drop_down_menu_append_item(menu, "自动", 0);
    ctk_drop_down_menu_append_item(menu, "启用", 1);
    ctk_drop_down_menu_append_item(menu, "禁用", 2);
...
setup_dithering_mode_menu(CtkDitheringControls *ctk_dithering_controls)
{
    ...
    for (i = 0; i < ctk_dithering_controls->dithering_mode_table_size; i++) {
        ...
        case NV_CTRL_DITHERING_MODE_DYNAMIC_2X2:
            ctk_drop_down_menu_append_item(dithering_mode_menu, "动态2x2", i);
            break;
        case NV_CTRL_DITHERING_MODE_STATIC_2X2:
            ctk_drop_down_menu_append_item(dithering_mode_menu, "静态2x2", i);
            break;
        case NV_CTRL_DITHERING_MODE_TEMPORAL:
            ctk_drop_down_menu_append_item(dithering_mode_menu, "暂时", i);
            break;
        default:
        case NV_CTRL_DITHERING_MODE_AUTO:
            ctk_drop_down_menu_append_item(dithering_mode_menu, "自动", i);
            break;
        }
    }
                                  ...
                                  gint dithering_config)
{
    static const char *dither_config_table[] = {
        "自动",    /* NV_CTRL_DITHERING_AUTO */
        "启用", /* NV_CTRL_DITHERING_ENABLED */
        "禁用" /* NV_CTRL_DITHERING_DISABLED */
    };
                                ...
                                gint dithering_mode)
{
    static const char *dither_mode_table[] = {
        "自动",        /* NV_CTRL_DITHERING_MODE_AUTO */
        "动态2x2", /* NV_CTRL_DITHERING_MODE_DYNAMIC_2X2 */
        "静态2x2",  /* NV_CTRL_DITHERING_MODE_STATIC_2X2 */
        "暂时",    /* NV_CTRL_DITHERING_MODE_TEMPORAL */
    };
                                 ...
                                 gint dithering_depth)
{
    static const char *dither_depth_table[] = {
        "自动",  /* NV_CTRL_DITHERING_DEPTH_AUTO */
