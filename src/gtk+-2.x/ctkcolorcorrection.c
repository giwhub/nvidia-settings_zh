                                    ...
                                    CtkEvent *ctk_event)
{
    ...
    button = gtk_button_new_with_label("重置硬件默认值");
    gtk_box_pack_end(GTK_BOX(hbox), button, FALSE, FALSE, 0);
    
    confirm_button = gtk_button_new();
    confirm_label = gtk_label_new("确认当前更改");
    ...
    label = gtk_label_new("警告：nvidia-settings外部的"
                          "色彩设置已经更改，所以当前的"
                          "滑块值可能不准确。");
