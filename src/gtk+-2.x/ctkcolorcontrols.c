                                  ...
                                  char *name)
{
    ...
    menu = (CtkDropDownMenu *)
        ctk_drop_down_menu_new(CTK_DROP_DOWN_MENU_FLAG_READONLY);
    ctk_drop_down_menu_append_item(menu, "完整", 0);
    ctk_drop_down_menu_append_item(menu, "限制", 1);
                                     ...
                                     gint color_range)
{
    static const char *color_range_table[] = {
        "完整",     /* NV_CTRL_CURRENT_COLOR_RANGE_FULL */
        "限制",  /* NV_CTRL_CURRENT_COLOR_RANGE_LIMITED */
    };
...
{
    static const char *color_range_table[] = {
        "完整",     /* NV_CTRL_COLOR_RANGE_FULL */
        "限制",  /* NV_CTRL_COLOR_RANGE_LIMITED */
    };
