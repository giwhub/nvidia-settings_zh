                                  ...
                                  CtkConfig *ctk_config)
{
    ...
    /* Apply button */
    ctk_object->btn_apply = gtk_button_new_with_label("应用");
    ...
    /* Probe button */
    ctk_object->btn_probe = gtk_button_new_with_label("检测显示");
    ...
    /* Advanced button */
    ctk_object->btn_advanced = gtk_button_new_with_label("高级...");
    ...
    /* Reset button */
    ctk_object->btn_reset = gtk_button_new_with_label("重置");
    ...
    { /* Layout section */
        ...
        frame = gtk_frame_new("布局"); /* main panel */
    ...
    { /* Display page */
        ...
        ctk_object->chk_forcecompositionpipeline_enabled =
            gtk_check_button_new_with_label("强制合成管道");
        ctk_config_set_tooltip(ctk_config,
                               ctk_object->chk_forcecompositionpipeline_enabled,
        ...
        ctk_object->chk_forcefullcompositionpipeline_enabled =
            gtk_check_button_new_with_label("强制全部合成管道");
        ctk_config_set_tooltip(ctk_config,
                               ctk_object->
                                            ...
                                            int *cur_idx)
{
    ...
    for (screen = layout->screens; screen; screen = screen->next_in_layout) {
        ...
        str = g_strdup_printf("X屏幕%d", screen->scrnum);
...
static void setup_display_refresh_dropdown(CtkDisplayConfig *ctk_object)
{
    ...
    if (IS_NVIDIA_DEFAULT_MODE(cur_modeline)) {
        ctk_combo_box_text_append_text(combo_box, "自动");
...
static void generate_selected_modes(const nvDisplayPtr display)
{
    ...
    if (display->screen->num_displays > 1) {
        selected_mode = allocate_selected_mode("关",
                                               NULL /* modeline */,
                                               TRUE /* isSpecial */,
                                               NULL /* viewPortIn */,
                                               NULL /* viewPortOut */);
...
static void generate_scaled_selected_modes(const nvDisplayPtr display)
{
    ...
    while ((commonResolutions[resIndex].w != -1) &&
        ...
        name = g_strdup_printf("%dx%d (缩放)", viewPortIn.w, viewPortIn.h);
