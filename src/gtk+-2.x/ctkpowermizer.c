                              ...
                              CtkEvent *ctk_event)
{
    ...
    label = gtk_label_new("PowerMizer信息");
    gtk_box_pack_start(GTK_BOX(hbox), label, FALSE, FALSE, 0);
    ...
    s = g_strdup_printf("PowerMizer监视器(GPU %d)",
    ...
    if ((ret == NvCtrlSuccess) &&
        ...
        label = gtk_label_new("PowerMizer设置");
