...
static const nvctrlFormatName targetFormatNames[] = {
    ...
    { NV_CTRL_THERMAL_SENSOR_TARGET_NONE,         "无"         },
    { NV_CTRL_THERMAL_SENSOR_TARGET_GPU,          "GPU"          },
    { NV_CTRL_THERMAL_SENSOR_TARGET_MEMORY,       "内存"       },
    { NV_CTRL_THERMAL_SENSOR_TARGET_POWER_SUPPLY, "电源" }, 
    { NV_CTRL_THERMAL_SENSOR_TARGET_BOARD,        "主板"        },
    { -1, NULL },
};

static const nvctrlFormatName providerFormatNames[] = {
    { NV_CTRL_THERMAL_SENSOR_PROVIDER_NONE,         "无"         },
    { NV_CTRL_THERMAL_SENSOR_PROVIDER_GPU_INTERNAL, "GPU内部" },
...
sensor_end:
    ...
    if ( ctk_thermal->cooler_count && ctk_thermal->show_fan_control_frame ) {
        ...
        ctk_thermal->enable_checkbox =
            gtk_check_button_new_with_label("启用GPU风扇设置");
        ...
        ctk_thermal->reset_button =
            gtk_button_new_with_label("重置硬件默认值");
