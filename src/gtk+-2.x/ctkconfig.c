...
GtkWidget* ctk_config_new(ConfigProperties *conf, CtrlSystem *pCtrlSystem)
{
    ...
    label = gtk_label_new("nvidia-settings配置");
...
static GtkWidget *create_timer_list(CtkConfig *ctk_config)
{
    ...
    column = gtk_tree_view_column_new_with_attributes("启用", renderer,
                                                      NULL);
    ...
    column = gtk_tree_view_column_new_with_attributes("说明",
                                                      renderer,
                                                      NULL);
    ...
    renderer = gtk_cell_renderer_text_new();
    column = gtk_tree_view_column_new_with_attributes("时间间隔",
                                                      renderer,
                                                      NULL);
